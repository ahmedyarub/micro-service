...
struct make_index_sequence_impl {
  using type = typename __make_integer_seq<integer_sequence, int, N>::type;
            ...
            namespace placeholders {
                __BOOST_DI_UNUSED static const struct arg {
                } _{};
            }
...
using is_convertible = decltype(test_is_convertible<T, U>(0));
                ...
                template<class T, class... TArgs>
                decltype(::boost::di::v1_1_0::aux::declval<T>().operator()(
                        ::boost::di::v1_1_0::aux::declval<TArgs>()...),
                        ::boost::di::v1_1_0::aux::true_type())
                is_invocable_impl(int);

                template<class, class...>
                ::boost::di::v1_1_0::aux::false_type is_invocable_impl(...);
                ...
                struct callable_base : callable_base_impl,
                                       aux::conditional_t<
                                               aux::is_class<T>::value && !aux::is_final<T>::value, T, aux::none_type> {
                };

                template<typename T>
                aux::false_type
                is_callable_impl(T *, aux::non_type<void (callable_base_impl::*)(...), &T::operator()> * = 0);
...
#if defined(__MSVC__)
                struct is_empty_expr<TExpr, valid_t<decltype(declval<TExpr>()())>> : integral_constant<bool,
                        sizeof(TExpr) == 1> {
                };
#else
...
// clang-format on
                ...
                struct get_not_supported<T, TDeps...>
                        : aux::conditional<
                                aux::is_a<core::injector_base, T>::value || aux::is_a<core::dependency_base, T>::value,
                ...
                -> aux::conditional_t<aux::is_same<T, aux::decay_t<T>>::value, decltype(boundable_impl(
                        aux::declval<any_of<Ts...>>())),
                ...
                -> aux::conditional_t<is_related<
                        aux::is_complete<I>::value && aux::is_complete<T>::value, I, T>::value, aux::true_type,
                        typename type_<T>::template is_not_related_to<I>>;

                template<class I, class T>
                auto boundable_impl(I *[],
                                    T &&) -> aux::conditional_t<aux::is_same<I, aux::decay_t<I>>::value, boundable_impl__<I, T>,
                ...
                template<class... TDeps>
                auto boundable_impl(
                        aux::type<TDeps...> &&) -> typename get_is_unique_error_impl<typename aux::is_unique<TDeps...>::type>::type;
            ...
            namespace concepts {
                ...
                -> aux::is_valid_expr<typename T::template scope<_, _>::template is_referable<_, config__<_>>,
                        ...
                        decltype(aux::declval<typename T::template scope<_, _>>().template create<_, _>(
                                provider__<_>{}))>;
            ...
            namespace core {
                ...
                struct pool<aux::type_list<TArgs...>> : TArgs ... {
                    ...
                    pool &operator=(T &&other) noexcept {
                        (void) aux::swallow{0, (static_cast<TArgs &>(*this).operator=(
                                static_cast<TArgs &&>(other)), 0)...};
                        return *this;
                    }
                };
            }
...
#define BOOST_DI_CFG_CTOR_LIMIT_SIZE 10
            ...
            namespace type_traits {
                ...
                struct ctor_impl<TIsConstructible, T, aux::index_sequence<Ns...>,
                        __BOOST_DI_REQUIRES(
                                (sizeof...(Ns) > 1) && TIsConstructible<T, get<core::any_type_fwd<T>, Ns>...>::value)>
                ...
                struct ctor_impl<TIsConstructible, T, aux::index_sequence<Ns...>,
                        ...
                        : aux::conditional<TIsConstructible<T, get<core::any_type_ref_fwd<T>, Ns>...>::value,
                                ...
                                typename ctor_impl<TIsConstructible, T, aux::make_index_sequence<
                                        sizeof...(Ns) - 1>>::type> {
                };
                template<template<class...> class TIsConstructible, class T>
            ...
            namespace scopes {
                ...
                namespace detail {
                    ...
                    template<class T>
                    struct has_result_type<T, ::boost::di::v1_1_0::aux::valid_t<typename T::result_type>>
                            : ::boost::di::v1_1_0::aux::true_type {
                    };
                    template<class TGiven, class TProvider, class... Ts>
                    struct is_expr
                            : aux::integral_constant<
                                    bool, aux::is_invocable<TGiven, typename TProvider::injector, Ts...>::value &&
                ...
                public:
                    ...
                    struct scope<TExpected, TGiven, __BOOST_DI_REQUIRES(aux::is_callable<TGiven>::value)> {
                        ...
                        aux::integral_constant<bool,
                                !aux::is_callable<TExpected>::value || !detail::has_result_type<TExpected>::value>;
    ...
    try_create(const TProvider&) noexcept;
                        ...
                        template<class, class, class TProvider, __BOOST_DI_REQUIRES(
                                detail::is_expr<TGiven, TProvider>::value) = 0>
                        auto create(const TProvider &provider) {
                        ...
                        template<class T, class, class TProvider,
                                __BOOST_DI_REQUIRES(
                                        detail::is_expr<TGiven, TProvider, const detail::arg<T, TExpected, TGiven> &>::value) = 0>
                        auto create(const TProvider &provider) {
                            using wrapper = detail::wrapper_traits_t<decltype((object_)(provider.super(),
                                                                                        detail::arg<T, TExpected, TGiven>{}))>;
                    ...
                    class scope<_, aux::type_list<Ts...>> {
                        ...
                        class injector_impl : injector__<Ts> ... {
                            ...
                            template<class T>
                            struct is_creatable
                                    : aux::integral_constant<bool, core::injector__<TInjector>::template is_creatable<T>::value> {
                            };
                            template<class TName, class T>
                        ...
                        public:
                            explicit injector_impl(TInjector &&injector) noexcept
                                    : injector__<Ts>(
                                    &injector_impl::template create<Ts, typename is_creatable<Ts>::type>::impl)...,
                                    dtor( &

                            injector_impl::dtor_impl),
                    ...
                    public:
                        ...
                        template<class TInjector, __BOOST_DI_REQUIRES(
                                aux::is_a<core::injector_base, TInjector>::value) = 0>
                        explicit scope(TInjector &&i) noexcept : injector_(
                                (injector *) new injector_impl<TInjector>{static_cast<TInjector &&>(i)}) {}
                        ...
                        template<class T, class TName, class TProvider>
                        static aux::conditional_t<aux::is_base_of<injector__<named<TName, T>>, injector>::value, T, void>
                        try_create(
                                const TProvider &);
            ...
            namespace core {
                ...
                class dependency : dependency_base,
                    ...
                    using externable = aux::integral_constant<
                            bool, aux::always<T>::value && aux::is_same<TScope, scopes::deduce>::value &&
                ...
                public:
                    ...
                    template<class T, __BOOST_DI_REQUIRES(
                            aux::is_same<TName, no_name>::value && !aux::is_same<T, no_name>::value) = 0>
                    auto named() noexcept {
                    ...
                    template<class T, __BOOST_DI_REQUIRES(externable<T>::value && !aux::is_callable<T>::value) = 0,
                            __BOOST_DI_REQUIRES_MSG(
                                    concepts::boundable<deduce_traits_t<TExpected, T>, aux::decay_t<T>, aux::valid<>>) = 0>
                    ...
                    template<class TConcept, class T, __BOOST_DI_REQUIRES(
                    ...
                    template<class... Ts, __BOOST_DI_REQUIRES(
                            sizeof...(Ts) && !aux::is_array<TExpected, Ts...>::value) = 0>
                ...
                class singleton {
                    ...
                    public:
                        ...
                        static decltype(wrappers::shared<singleton, T &>{
                                aux::declval<TProvider>().get(type_traits::stack{})}) try_create(
                                const TProvider &);
...
#define BOOST_DI_CFG ::boost::di::v1_1_0::config
            ...
            struct bind :
                    ...
                    detail::bind<__BOOST_DI_REQUIRES_MSG(
                            concepts::boundable<concepts::any_of<Ts...>>), scopes::deduce, Ts...>::type
#if defined(__cpp_variable_templates)
                bind
#endif
            {
            ...
            namespace concepts {
                ...
                template<class T>
                auto
                configurable_impl(T &&) -> aux::is_valid_expr<decltype(aux::declval<T>().provider((injector<T> *) 0)),
                ...
                auto is_configurable(const aux::true_type &) {
                    return typename get_configurable_error<decltype(providable<decltype(aux::declval<T>().provider(
                            (injector<T> *) 0))>()),
            ...
            namespace core {
                struct binder {
                    ...
                    struct resolve__ {
                        using type = decltype(resolve_impl__<TDefault, dependency_concept<aux::decay_t<T>, TName>>(
                                (TDeps *) 0));
                    };
    ...
    return {};
            ...
            namespace core {
                ...
                struct any_type_ref {
                    ...
                    operator T &&() const {
                        return static_cast<const core::injector__<TInjector> &>(injector_).create_impl(
                                aux::type<T &&>{});
                    }
            ...
            namespace core {
                ...
                class policy {
                    template<class TArg, class TPolicy, class TPolicies,
                            __BOOST_DI_REQUIRES(
                                    !aux::is_base_of<_, aux::remove_reference_t<typename TArg::type>>::value) = 0>
  ...
  static inline T type(_ = "creating...");
                ...
                struct provider<aux::pair<T, aux::pair<TInitialization, TList<TCtor...>>>, TName, TInjector> {
                    ...
                    auto get(const TMemory &memory = {}) const {
                        return get_impl(memory, ((const injector__<TInjector> *) injector_)->create_impl(
                                aux::type<TCtor>{})...);
                    }

                    template<class TMemory, class... TArgs, __BOOST_DI_REQUIRES(
                            is_creatable<TMemory, TArgs...>::value) = 0>
...
#endif
                        return cfg().provider(injector_).template get<T>(TInitialization{}, memory,
                    ...
                    struct provider<aux::pair<T, aux::pair<TInitialization, TList<TCtor...>>>, TInjector> {
                        ...
                        auto get(const TMemory &memory = {}) const {
                            return cfg().provider(injector_).template get<T>(
                                    ...
                                    ((const injector__<TInjector> *) injector_)->create_successful_impl(
                                            aux::type<TCtor>{})...);
                        }
            ...
            namespace core {
                    ...
                    struct is_creatable {
                        ...
                        static constexpr auto value =
                                aux::is_convertible<decltype(dependency__<dependency_t>::template try_create<T, TName>(
                                        try_provider<ctor_t, injector, decltype(aux::declval<TConfig>().provider(
                                                (injector *) 0))>{})),
                                        T>::value &&
                ...
                public:
                    ...
                    template<class... TArgs>
                    explicit injector(const init &, TArgs... args) noexcept : injector{from_deps{},
                                                                                       static_cast<TArgs &&>(args)...} {}
                    ...
                    explicit injector(injector<TConfig_, TPolicies_, TDeps_...> &&other) noexcept
                            : injector{from_injector{},
                                       static_cast<injector<TConfig_, TPolicies_, TDeps_...> &&>(other), deps{}} {}
                ...
                protected:
                    ...
                    auto create_successful_impl(
                            const aux::type<core::ctor_arg<TParent, N, const placeholders::arg &>> &) const {
                        return any_type_1st_ref<TParent, injector, aux::false_type, aux::true_type>{*this};
                    }
    ...
    bindings_t<TArgs...>{}, pool_t { TArgs{static_cast<TInjector&&>(injector)}... }
                    ...
                    auto create_impl__() const {
                        ...
                        using wrapper_t =
                        decltype(static_cast<dependency__<dependency_t> &>(dependency).template create<T, TName>(
                                provider_t{this}));
                        using ctor_args_t = typename ctor_t::second::second;
                        ...
                        return wrapper<T, wrapper_t>{
                                static_cast<dependency__<dependency_t> &>(dependency).template create<T, TName>(
                                        provider_t{this})};
                    }
...
#define __BOOST_DI_MAKE_INJECTOR(...) detail::make_injector(__VA_ARGS__)
            ...
            inline auto make_injector(TDeps... args) noexcept {
                return __BOOST_DI_MAKE_INJECTOR(
                        core::injector<TConfig, decltype(((TConfig *) 0)->policies(
                                (concepts::injector<TConfig> *) 0)), TDeps...>{
            ...
            namespace policies {
                namespace detail {
                    ...
                    struct apply_impl<T<Ts...>, __BOOST_DI_REQUIRES(!aux::is_base_of<type_op, T < Ts...>>
                                                                            ::value)> {
                    ...
                    struct not_ : detail::type_op {
                        template<class TArg>
                        struct apply
                                : aux::integral_constant<bool, !detail::apply_impl<T>::template apply<TArg>::value> {
                        };
                    };
                    template<class... Ts>
                ...
                struct constructible_impl {
                    template<class TArg, __BOOST_DI_REQUIRES(
                            TArg::is_root::value || T::template apply<TArg>::value) = 0>
